...
class AideMixin:
    ...
    def afficher_aide(self):
        ...
        sections = [
            ...
            ("↩️ Le client rapporte un article (annulation)", [
            ...
            ("📊 Savoir ce qui se vend DE MOINS EN MOINS", [
                ...
                "   • ↘️ En baisse / 📉 Forte baisse = ça décroche, attention au stock mort",
            ...
            ("↩️ Un client rapporte une pièce", [
